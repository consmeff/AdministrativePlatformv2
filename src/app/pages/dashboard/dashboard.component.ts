...
import { Application, ApplicationListResponse, ApplicationSummary } from '../../model/dashboard/applicant';
...
@Component({
  ...
  imports: [CommonModule,RouterModule, SidebarComponent, TopbarComponent, DoughnutComponent, DropdownModule, FormsModule, TableModule],
...
busyService = inject(BusyIndicatorService);
  ...
  populateSummary() {
    let batch=this.applicationList.slice(0,5);
    batch.forEach((v,i)=>{
